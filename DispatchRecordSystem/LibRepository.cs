...
public class LibRepository
{
    ...
    {
        UserService usr = new UserService(new Repository<User>(new LogisticsDbContext()));
        //usr.CreateUser("KinionK", "password"); 
        Console.WriteLine(usr.ConfirmLogin("KinionK", "password"));
